package com.example.examactivityfragment.provider
...
class ContentProviderP : ContentProvider() {

        companion object{
            const val PROVIDER_NAME = "com.example.user"
            const val URL = "content://$PROVIDER_NAME/user"
